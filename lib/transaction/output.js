...
function Output(args) {
  ...
  if (_.isObject(args)) {
    ...
    this.ok = _.isString(args.ok) ? blsct.mcl.deserializeHexStrToG1(args.ok) : args.ok;
    this.ek = _.isString(args.ek) ? blsct.mcl.deserializeHexStrToG1(args.ek) : args.ek;
    this.sk = _.isString(args.sk) ? blsct.mcl.deserializeHexStrToG1(args.sk) : args.sk;
    this.bp = {V: [], L: [], R: []}
    if (args.bp)
    {
      ...
      this.bp.A = _.isString(args.bp.A) ? blsct.mcl.deserializeHexStrToG1(args.bp.A) : args.bp.A;
      this.bp.S = _.isString(args.bp.S) ? blsct.mcl.deserializeHexStrToG1(args.bp.S) : args.bp.S;
      this.bp.T1 = _.isString(args.bp.T1) ? blsct.mcl.deserializeHexStrToG1(args.bp.T1) : args.bp.T1;
      this.bp.T2 = _.isString(args.bp.T2) ? blsct.mcl.deserializeHexStrToG1(args.bp.T2) : args.bp.T2;
      this.bp.taux = _.isString(args.bp.taux) ? blsct.mcl.deserializeHexStrToFr(args.bp.taux) : args.bp.taux;
      this.bp.mu = _.isString(args.bp.mu) ? blsct.mcl.deserializeHexStrToFr(args.bp.mu) : args.bp.mu;
      this.bp.a = _.isString(args.bp.a) ? blsct.mcl.deserializeHexStrToFr(args.bp.a) : args.bp.a;
      this.bp.b = _.isString(args.bp.b) ? blsct.mcl.deserializeHexStrToFr(args.bp.b) : args.bp.b;
      this.bp.t = _.isString(args.bp.t) ? blsct.mcl.deserializeHexStrToFr(args.bp.t) : args.bp.t;
    }
