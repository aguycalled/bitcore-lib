...
Output.prototype.toObject = Output.prototype.toJSON = function toObject() {
  ...
  if (this.bp && this.bp.V && this.bp.V.length) {
    ...
    if (this.bp) {
      ...
      if (this.bp.A) obj.bp.A = this.bp.A.serialize();
      if (this.bp.S) obj.bp.S = this.bp.S.serialize();
      if (this.bp.T1) obj.bp.T1 = this.bp.T1.serialize();
      if (this.bp.T2) obj.bp.T2 = this.bp.T2.serialize();
      if (this.bp.taux) obj.bp.taux = this.bp.taux.serialize();
      if (this.bp.mu) obj.bp.mu = this.bp.mu.serialize();
      if (this.bp.a) obj.bp.a = this.bp.a.serialize();
      if (this.bp.b) obj.bp.b = this.bp.b.serialize();
      if (this.bp.t) obj.bp.t = this.bp.t.serialize();
    }
...
Output.prototype.toBufferWriter = function (writer) {
  ...
  if (!isZero || this.vData.length > 0 || this.tokenNftId != -1) {
    ...
    if (flags & (0x1 << 5)) {
      writer.write(this.tokenId.reverse());
    }
    if (flags & (0x1 << 6)) {
      write.writeUInt64LEBN(writer, this.tokenNftId);
    }
    if (flags & (0x1 << 7)) {
      writer.writeVarintNum(this.vData.length);
      writer.write(this.vData);
    }
