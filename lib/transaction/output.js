...
Output.prototype.toBufferWriter = function(writer) {
  ...
  if ((this.ek && this.ek.serialize().length > 0) || (this.ok && this.ok.serialize().length > 0) || (this.sk && this.sk.serialize().length > 0)) {
      ...
      writer.writeVarintNum(this.ek ? this.ek.serialize().length : 0);
      if (this.ek) {
        writer.write(this.ek.serialize());
      }
      writer.writeVarintNum(this.ok ? this.ok.serialize().length : 0);
      if (this.ok) {
        writer.write(this.ok.serialize());
      }
      writer.writeVarintNum(this.sk ? this.sk.serialize().length : 0);
      if (this.sk) {
      ...
      writer.writeVarintNum(this.bp.A ? this.bp.A.serialize().length : 0);
      if (this.bp.A)
        writer.write(this.bp.A.serialize());
      writer.writeVarintNum(this.bp.S ? this.bp.S.serialize().length : 0);
      if (this.bp.S)
        writer.write(this.bp.S.serialize());
      writer.writeVarintNum(this.bp.T1 ? this.bp.T1.serialize().length : 0);
      if (this.bp.T1)
        writer.write(this.bp.T1.serialize());
      writer.writeVarintNum(this.bp.T2 ? this.bp.T2.serialize().length : 0);
      if (this.bp.T2)
        writer.write(this.bp.T2.serialize());
      writer.writeVarintNum(this.bp.taux ? this.bp.taux.serialize().length : 0);
      if (this.bp.taux)
        writer.write(this.bp.taux.serialize());
      writer.writeVarintNum(this.bp.mu ? this.bp.mu.serialize().length : 0);
      if (this.bp.mu)
        writer.write(this.bp.mu.serialize());
      writer.writeVarintNum(this.bp.a ? this.bp.a.serialize().length : 0);
      if (this.bp.a)
        writer.write(this.bp.a.serialize());
      writer.writeVarintNum(this.bp.b ? this.bp.b.serialize().length : 0);
      if (this.bp.b)
        writer.write(this.bp.b.serialize());
      writer.writeVarintNum(this.bp.t ? this.bp.t.serialize().length : 0);
      if (this.bp.t)
