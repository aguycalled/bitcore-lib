...
Transaction.prototype.toBufferWriter = function(writer) {
  ...
  console.log('da',this.version & 0x10,this.version & 0x20);
...
Transaction.prototype.fromObject = function fromObject(arg) {
  ...
  _.each(transaction.inputs, function(input) {
    ...
    var txin;
    if (script.isPublicKeyHashOut() || script.isColdStakingOut() || script.isColdStakingV2Out()) {
...
Transaction.prototype._fromNonP2SH = function(utxo) {
  ...
  if (utxo.script.isPublicKeyHashOut() || utxo.script.isColdStakingOut() || utxo.script.isColdStakingV2Out()) {
