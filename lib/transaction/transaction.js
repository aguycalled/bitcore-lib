...
Transaction.prototype.toBufferWriter = function (writer) {
  ...
  if (this.version & 0x10 || this.version & 0x20) {
    writer.writeVarintNum(Buffer.from(this.vchbalsig).length);
    writer.write(Buffer.from(this.vchbalsig));
  }
  if (this.version & 0x10) {
    writer.writeVarintNum(Buffer.from(this.vchtxsig).length);
    writer.write(Buffer.from(this.vchtxsig));
  }
  return writer;
};
...
Transaction.prototype.toObject = Transaction.prototype.toJSON =
    function toObject() {
      ...
      var obj = {
        ...
        vchbalsig: Buffer.from(this.vchbalsig),
        vchtxsig: Buffer.from(this.vchtxsig),
      };
