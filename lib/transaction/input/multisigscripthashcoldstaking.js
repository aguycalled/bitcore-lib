...
function MultiSigScriptHashInputColdStaking(input, pubkeys, threshold, signatures, staking) {
  ...
  console.log(">>MultiSigScriptHashInputColdStaking: "+[input, pubkeys, threshold, signatures, staking])
  this.publicKeys = _.sortBy(pubkeys, function(publicKey) { return publicKey.toString('hex'); });
  console.log(">>buildPayToColdStaking: "+[staking, this.publicKeys, threshold])
